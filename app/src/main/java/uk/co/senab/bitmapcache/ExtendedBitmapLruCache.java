 ...
 * Time: 20:55
 */
public class ExtendedBitmapLruCache  {
    ...
    ExtendedBitmapLruCache(Context context) {
        if (null != context) {
    ...
    public DiskLruCache.Snapshot getFromDiskCacheRaw(final String url) {
        if (null != mDiskCache) {
            checkNotOnMainThread();
    ...
    void setMemoryCache(BitmapMemoryLruCache memoryCache, BitmapLruCache.RecyclePolicy recyclePolicy) {
    ...
    public final static class Builder {
        ...
        static final BitmapLruCache.RecyclePolicy DEFAULT_RECYCLE_POLICY = BitmapLruCache.RecyclePolicy.ALWAYS;
         ...
         *         builder.
         */
        public ExtendedBitmapLruCache build() {
            final ExtendedBitmapLruCache cache = new ExtendedBitmapLruCache(mContext);
         ...
         * @return This Builder object to allow for chaining of calls to set methods.
         */
        public Builder setRecyclePolicy(BitmapLruCache.RecyclePolicy recyclePolicy) {
