 ...
 */
public class MasonryView extends AbsListView {
     ...
     */
    AbsListView.OnItemClickListener mOnItemClickListener;

    /**
     * The listener that receives notifications when an item is long clicked.
     */
    AbsListView.OnItemLongClickListener mOnItemLongClickListener;
    ...
    public MasonryView(Context context) {
        this(context, null);
    }

    public MasonryView(Context context, AttributeSet attrs) {
